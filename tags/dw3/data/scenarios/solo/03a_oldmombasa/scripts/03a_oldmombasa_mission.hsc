...
(script dormant e13_cov_creep0_main
	...
	(ai_vehicle_enter_immediate e13_cov_creep0_0/passenger1 (ai_vehicle_get e13_cov_creep0_0/creep0) "creep_p_l01")
	(ai_vehicle_enter_immediate e13_cov_creep0_0/passenger2 (ai_vehicle_get e13_cov_creep0_0/creep0) "creep_p_r01")
	(ai_vehicle_enter_immediate e13_cov_creep0_0/passenger3 (ai_vehicle_get e13_cov_creep0_0/creep0) "creep_p_l02")
	(ai_vehicle_enter_immediate e13_cov_creep0_0/passenger4 (ai_vehicle_get e13_cov_creep0_0/creep0) "creep_p_r02")
	(ai_vehicle_enter_immediate e13_cov_creep0_2/passenger1 (ai_vehicle_get e13_cov_creep0_2/creep0) "creep_p_l01")
	(ai_vehicle_enter_immediate e13_cov_creep0_2/passenger2 (ai_vehicle_get e13_cov_creep0_2/creep0) "creep_p_r01")
	(sleep 2)
...
(script command_script cs_e11_cov_creep0_entry
	(cs_enable_pathfinding_failsafe true)
	(cs_go_to e11_cov_phantom0/p4)
	(sleep 60)
	(ai_vehicle_exit e11_cov_creep0/driver)
)
...
(script dormant e10_guntower0_destroyed
	(sleep_until 
		(or
	...
	(effect_new dw3\effects\scenarios\objects\covenant\military\cov_guntower\trans_hull_destroyed e10_guntower_destroyed)
	(ai_kill e10_cov_inf1/gunner0)
)
...
(script dormant e9_guntower0_destroyed
	(sleep_until 
		(or
	...
	(effect_new dw3\effects\scenarios\objects\covenant\military\cov_guntower\trans_hull_destroyed e9_guntower_destroyed)
	(ai_kill e9_cov_inf1_1/gunner0)
)
...
(script command_script cs_e8_cov_ghosts0_entry
	...
	(cs_vehicle_boost true)
	(cs_go_to e8_cov_ghosts0_entry/p1)
	(sleep 150)
	(ai_vehicle_exit e8_cov_creep0_1/driver)
	(sleep 45)
...
(script command_script cs_e8_cov_wraith_shoot
	(cs_abort_on_damage true)
	(cs_enable_targeting true)
	...
	(sleep_until 
		(begin
			(begin_random
				(begin
					(cs_shoot_point true e8_wraith_shoot/p0)
					(sleep (random_range 100 150))
				)
				(begin
					(cs_shoot_point true e8_wraith_shoot/p1)
					(sleep (random_range 45 90))
				)
				(begin
					(cs_shoot_point true e8_wraith_shoot/p2)
					(sleep (random_range 45 90))
				)
			)
			false
...
(script command_script cs_e8_cov_inf1_look
	(cs_abort_on_damage true)
	(cs_enable_moving false)
	(sleep_until 
		(or
			(= (ai_living_count e8_cov_inf1) 2)
			(<= (ai_living_count e8_cov) 6)
		)
	)
	(cs_enable_moving true)
)

(script command_script c8_cov_wraith0_dropoff
	(cs_enable_pathfinding_failsafe true)
	(cs_vehicle_speed 2.0)
	(cs_fly_by e8_cov_wraith0_dropoff/p0)
	(cs_fly_to_and_face e8_cov_wraith0_dropoff/p1 e8_cov_wraith0_dropoff/p2)
	(cs_enable_pathfinding_failsafe false)
	(cs_fly_to e8_cov_wraith0_dropoff/p2)
	(sleep 45)
	(cs_face true e8_cov_wraith0_dropoff/p0)
	(cs_enable_pathfinding_failsafe true)
	(vehicle_unload (ai_vehicle_get ai_current_actor) "phantom_lc")
	(ai_braindead e8_cov_wraith0/wraith0 false)
	(sleep 45)
	(cs_fly_to e8_cov_wraith0_dropoff/p4)
	(cs_fly_to e8_cov_wraith0_dropoff/p0)
	(cs_fly_to_and_face e8_cov_wraith0_dropoff/p3 e8_cov_wraith0_dropoff/p5)
	(object_destroy (ai_vehicle_get e8_cov_wraith0/phantom0))
	(ai_erase e8_cov_wraith0/phantom0)
)

(script command_script e8_cov_wraith_shoot_abort
	(sleep 1)
)

(script command_script e8_cov_bugger0
	(cs_fly_to e8_cov_buggers_fly/bugger0)
)

(script command_script e8_cov_bugger1
	(sleep 10)
	(cs_fly_to e8_cov_buggers_fly/bugger1)
)

(script command_script e8_cov_bugger2
	(sleep 20)
	(cs_fly_to e8_cov_buggers_fly/bugger2)
)

(script command_script e8_cov_bugger3
	(sleep 15)
	(cs_fly_to e8_cov_buggers_fly/bugger3)
)
...
(script dormant e8_cov_wraith0_main
	...
	(vehicle_load_magic (ai_vehicle_get_from_starting_location e8_cov_wraith0/phantom0) "phantom_lc" (ai_vehicle_get_from_starting_location e8_cov_wraith0/wraith0))
	(ai_braindead e8_cov_wraith0/wraith0 true)
	(sleep_until (volume_test_objects tv_e8_cov_wraith_spotted (players)))
	(cs_run_command_script e8_cov_wraith0/wraith0 e8_cov_wraith_shoot_abort)
)

(script dormant e8_cov_hunters0_main
	(if (difficulty_legendary) (ai_place e8_cov_hunters0))
)

(script dormant e8_cov_creep0_0_main
	(ai_place e8_cov_creep0_0)
	(sleep 90)
	(object_dynamic_simulation_disable (ai_vehicle_get_from_starting_location e8_cov_creep0_0) true)
	(sleep_until (= (ai_living_count e8_cov_creep0_0) 0))
	(object_dynamic_simulation_disable (ai_vehicle_get_from_starting_location e8_cov_creep0_0) false)
)

(script dormant e8_cov_creep0_1_main
	(sleep_until (= (ai_living_count e8_cov) 3))
	(ai_place e8_cov_creep0_1)
)

(script dormant e8_cov_buggers_main
	(sleep_until (= (ai_living_count e8_cov) 3))
	(ai_place e8_cov_buggers)
	(sleep 60)
	(sleep (ai_play_line e8_mars_inf0 0490))
)

(script dormant e8_cov_ghost0_1_main
	(sleep_until (= (ai_living_count e8_cov) 5))
	(ai_place e8_cov_ghosts0_1)
	(sleep_until 
		(or
			(and
				(> (ai_spawn_count e8_cov_ghosts0_1) 0)
				(<= (ai_living_count e8_cov_ghosts0_1) 1)
			)
...
(script dormant cortana_the_hedgehog
	(sleep_until (volume_test_objects tv_e8_hotel_exit (players)))
...
(script dormant e8_main
	(sleep_until (volume_test_objects tv_e8_main_begin (players)))
...
;	(wake e8_cov_ghosts0_main)
	(wake e8_cov_ghost0_1_main)
	(wake e8_mars_warthog0_main)
	(wake e8_cov_hunters0_main)
	(wake e8_cov_creep0_0_main)
	(wake e8_cov_creep0_1_main)
	(wake e8_cov_buggers_main)
...
(script dormant e7_mars_inf0_main
	...
	(ai_migrate e6_mars_inf1/marine3 e7_mars_inf0)
...
(global boolean g_e5_oops_done false)
(global boolean shhhh_done false)
...
(script command_script turret_deployment
	(cs_enable_pathfinding_failsafe true)
	(cs_force_combat_status 4)
	(cs_go_to e5_cov_turret_deployment/p0)
	(cs_deploy_turret e5_cov_turret_deployment/p0)
)
...
(script command_script cs_e5_cov_inf0_grunt0
	...
	(sleep 30)
	(unit_add_equipment (unit (list_get (ai_actors ai_current_actor) 0)) unarmed TRUE TRUE)
	(object_create_anew e5_cov_inf0_pistol)
	(sleep 10)
	(ai_play_line ai_current_actor 0390)
	(set g_e5_oops_done TRUE)
	(sleep 20)
	(cs_force_combat_status 3)
	(cs_go_to e5_cov_ambush/inf0_grunt0_p1)
	(unit_add_equipment (unit (list_get (ai_actors ai_current_actor) 0)) needlergang TRUE TRUE)
	(sleep_until (ai_trigger_test e5_cov_inf0_ambush_sprung ai_current_squad) 5)
)

(script command_script shhhh
	(cs_abort_on_damage true)
	(cs_abort_on_combat_status ai_combat_status_clear_los)
	(cs_crouch true)
	(sleep_until (= g_e5_oops_done TRUE))
	(ai_play_line ai_current_actor 0400)
	(sleep 90)
	(set shhhh_done TRUE)
	(sleep_until (ai_trigger_test e5_cov_inf0_ambush_sprung ai_current_squad) 5)
)

(script command_script e5_marine_cautious1
	(sleep (ai_play_line ai_current_actor 0420))
)

(script command_script e5_marine_cautious2
	(sleep_until (= shhhh_done true))
	(if (< (ai_combat_status e5_cov) ai_combat_status_dangerous)
...
(script dormant e5_cov_inf3_main
	...
	(ai_place e5_cov_inf3/elite0)
	(ai_place e5_cov_inf3/grunt0)
	(ai_place e5_cov_inf3/grunt1)
	(sleep 30)
	(if (not (difficulty_legendary)) (sleep_forever))
	(sleep_until 
		(volume_test_objects tv_e5_player_advanced (players))
	)
	(if (< (ai_living_count covenant) 15) (ai_place e5_cov_inf3/zealot))
)
...
(script dormant e5_cov_inf1_main
	...
	(sleep_until 
		(ai_trigger_test e5_cov_inf0_ambush_sprung ai_current_squad)
		15
	)
...
(script dormant e5_cov_inf0_main
	(ai_place e5_cov_infzero)
	(ai_place e5_cov_inf0_1)
	(cs_run_command_script e5_cov_infzero/grunt1 shhhh)
	(sleep_until (ai_trigger_test e5_cov_inf0_ambush_sprung ai_current_squad) 5)
	(ai_place e5_cov_gunner)
...
(script dormant e5_mars_inf0_main
	...
	(sleep_until (volume_test_objects tv_e5_marine_scene (players)))
	(ai_scene e5_alley_caution1 e5_marine_cautious1 e5_mars_inf0)
	(sleep 150)
	(ai_scene e5_alley_caution2 e5_marine_cautious2 e5_mars_inf0)
)
...
(global object marine0 none)
(global object marine1 none)
...
(script command_script cs_e3_sniper_intro_scene
	(cs_switch marine_0)
	(sleep (ai_play_line ai_current_actor 0370)) ; "Snipers suxor"
...
(script command_script e3_cov_ghost0_ultra
	(cs_enable_pathfinding_failsafe true)
	(cs_go_to e3_cov_ghosts0_driveby/ultra)
	(object_destroy (ai_vehicle_get ai_current_actor))
	(ai_erase ai_current_actor)
)

(script command_script e3_cov_ghost0_major0
	(cs_enable_pathfinding_failsafe true)
	(sleep 30)
	(cs_go_to e3_cov_ghosts0_driveby/major0)
	(object_destroy (ai_vehicle_get ai_current_actor))
	(ai_erase ai_current_actor)
)

(script command_script e3_cov_ghost0_major1
	(cs_enable_pathfinding_failsafe true)
	(sleep 30)
	(cs_go_to e3_cov_ghosts0_driveby/major1)
	(object_destroy (ai_vehicle_get ai_current_actor))
	(ai_erase ai_current_actor)
)

(script command_script e3_cov_ghost0_minor0
	(cs_enable_pathfinding_failsafe true)
	(sleep 60)
	(cs_go_to e3_cov_ghosts0_driveby/major0)
	(object_destroy (ai_vehicle_get ai_current_actor))
...
(script command_script e3_cov_ghost0_minor1
	(cs_enable_pathfinding_failsafe true)
	(sleep 60)
	(cs_go_to e3_cov_ghosts0_driveby/major1)
	(object_destroy (ai_vehicle_get ai_current_actor))
...
(script command_script e3_cov_ghost0_minor2
	(cs_enable_pathfinding_failsafe true)
	(sleep 90)
	(cs_go_to e3_cov_ghosts0_driveby/major0)
	(object_destroy (ai_vehicle_get ai_current_actor))
...
(script command_script e3_cov_ghost0_minor3
	(cs_enable_pathfinding_failsafe true)
	(sleep 90)
	(cs_go_to e3_cov_ghosts0_driveby/major1)
	(object_destroy (ai_vehicle_get ai_current_actor))
...
(script command_script e3_cov_inf0_elite0
	(cs_abort_on_alert true)
	(cs_enable_pathfinding_failsafe true)
	(ai_disregard (ai_actors e3_cov_ghosts0) true)
	(cs_go_to e3_cov_inf0_0_entry/p3)
	(sleep_forever)
)

(script command_script e3_cov_inf0_grunt0
	(cs_abort_on_alert true)
	(cs_enable_pathfinding_failsafe true)
	(ai_disregard (ai_actors e3_cov_ghosts0) true)
...
(script command_script e3_cov_inf0_grunt1
	(cs_abort_on_alert true)
	(cs_enable_pathfinding_failsafe true)
	(ai_disregard (ai_actors e3_cov_ghosts0) true)
...
(script command_script e3_cov_inf0_grunt2
	(cs_abort_on_alert true)
	(cs_enable_pathfinding_failsafe true)
	(ai_disregard (ai_actors e3_cov_ghosts0) true)
...
(script command_script e3_cov_turret_deployment
	(cs_deploy_turret e3_cov_inf0_turret_deployment/p0)
)
...
(script dormant e3_cov_inf0_main
	...
	(cs_run_command_script e3_cov_inf0_0/grunt2 e3_cov_turret_deployment)
)

(script dormant e3_cov_ghosts0_main
	(sleep_until (volume_test_objects tv_e3_main_begin0 (players)))
...
(script command_script cs_e2_mars_johnson0_dialogue0
	...
	(sleep 10)
	(sound_impulse_start_effect sound\dialog\levels\03_earthcity\mission\l03_0930_jon NONE 1 "radio_default"); "Johnson: Hah."
)
...
;	(ai_play_line e2_mars_johnson 0920) ; "Nevermind"
	...
	(sound_impulse_start_effect sound\dialog\levels\03_earthcity\mission\l03_0930_jon NONE 1 "radio_default")
...
(global boolean g_e1_mars_ready false)					; Johnson and the pilots are ready to leave with the Falcon.
(global boolean g_e1_mars_clear false)					; All covvies in e1 are dead.
(global boolean g_e1_mars_capiche false)				; Miranda gave her orders to Johnson.
(global boolean johnson_go false)						; Johnson can now board the Falcon.
(global boolean go_pilots false)						; The Pilots can go to the landing site.
(global boolean board_pilots false)						; The Pilots can now board the Falcon.
(global boolean lz_is_clear false)						; E4 is all dead.
...
(script command_script cs_e1_mars_johnson_finale
	(sleep 60)
	(set g_e1_mars_clear true)
	(sleep_until (= johnson_go true))
	(cs_enable_pathfinding_failsafe true)
	...
	(sleep_until g_e1_mars_capiche 5)
	(ai_play_line_at_player e1_mars_johnson 0040) ; "Johnson: Bye Chief, off to wuss."
	(sleep 20)
	(custom_animation (ai_get_unit ai_current_actor) "objects\characters\marine\marine" "combat:rifle:wave" true)
	(sleep (unit_get_custom_animation_time (ai_get_unit ai_current_actor)))
...
(script command_script pilot_finale1
...
(script command_script pilot_finale2
	(sleep_until (= go_pilots true))
	(cs_enable_pathfinding_failsafe true)
...
(script static void e1_cov_inf2_0_spawn
	; If player isn't in the unsafe volume...
	(if (not (volume_test_objects tv_e1_cov_inf2_1_unsafe (players)))
		(begin
			; Fire off a checkpoint
			...
			; Place the squad and increment the counter
			(ai_place e1_cov_inf2_0 (min 5 (- 10 (ai_living_count e1_cov_inf2))))
			(ai_set_orders e1_cov_inf2_0 e1_cov_inf2_engage0)
			(sleep 2)
			(ai_magically_see e1_mars_johnson e1_cov_inf2_0)
			(set g_e1_cov_inf2_spawned (+ g_e1_cov_inf2_spawned 1))
...
(script dormant e1_mars_pelican0_main
	...
	(sleep_until g_e1_mars_clear 5)
	(garbage_collect_unsafe)
	(sleep (ai_play_line e1_mars_johnson 0010)) ; "Johnson: Evac comin' in! If you're bleedin', you're leavin'!"
	(sleep 20)
	(sleep (ai_play_line_on_object none 0020)) ; "Miranda: You, too Sergeant."
	(sleep 60)
	(sleep (ai_play_line_on_object none 0030)) ; "Miranda: Move the wounded to a safe location, then return to the ship."
	(set g_e1_mars_capiche true)
	(sleep_until g_e1_mars_ready 5)
...
(script dormant e1_cov_inf4_main
	...
	(sleep_until (= (ai_living_count e1_cov_inf4_1) 0) 10)
	(set lz_is_clear true)
)
...
(script dormant e1_cov_inf2_main
	...
	; Spawn the waves
	(begin_random 
		(if (e1_cov_inf2_under_limit) (e1_cov_inf2_0_spawn))
		(if (e1_cov_inf2_under_limit) (e1_cov_inf2_1_spawn))
...
(script dormant e1_mars_johnson_main
	...
	(cs_run_command_script e1_mars_inf1/marine0 pilot_finale1)
	(cs_run_command_script e1_mars_inf1/marine1 pilot_finale2)
