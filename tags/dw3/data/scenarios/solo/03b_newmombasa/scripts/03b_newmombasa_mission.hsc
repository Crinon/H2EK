...
(script command_script cs_e23_scarab_shoot_pelican0
	...
	; Shoot
	(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab 1.0)
...
(script command_script cs_e23_scarab_upper_gun
	; Shoot
	(cs_shoot true (ai_vehicle_get e23_mars_pelican0_0/pelican0))
	(sleep_forever)
)
...
(script command_script scorpions0_shoot
	(cs_shoot_point true e23_mars_scorpions0_scene/shoot0)
	(sleep 300)
	(cs_shoot_point true e23_mars_scorpions0_scene/shoot2)
	(sleep_forever)
)

(script command_script pelican0_leave
	(cs_enable_pathfinding_failsafe true)
	(cs_fly_to e23_mars_scorpions0_scene/p0)
	(cs_fly_to e23_mars_scorpions0_scene/p2)
	(cs_fly_to_and_face e23_mars_scorpions0_scene/p4 e23_mars_scorpions0_scene/look0)
	(ai_erase ai_current_actor)
)

(script command_script pelican1_leave
	(cs_enable_pathfinding_failsafe true)
	(sleep 90)
	(cs_fly_to e23_mars_scorpions0_scene/p1)
	(cs_fly_to e23_mars_scorpions0_scene/p3)
	(cs_fly_to e23_mars_scorpions0_scene/p5)
	(ai_erase ai_current_actor)
)

(script command_script blow_them_tf_up
	(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab 1.0)
	(cs_shoot_point true e23_mars_scorpions0_scene/shoot1)
	(sleep 150)
	(ai_erase ai_current_actor)
)
...
(script dormant e23_scarab
	...
	(ai_place scarab_gunners/right_gunner0)
	(ai_place scarab_gunners/right_gunner1)
	(if	(object_model_target_destroyed (object_at_marker scarab "side_gun_fr") "target_front")
		(ai_erase scarab_gunners/right_gunner0)
	)
	(if	(object_model_target_destroyed (object_at_marker scarab "side_gun_br") "target_front")
		(ai_erase scarab_gunners/right_gunner1)
	)
...
; Old	(scarab_walk_low_var0) ;<none>
	...
	(scarab_walk_low_var0)	
	(cs_run_command_script e23_mars_scorpions0/scorpion0 scorpions0_shoot)
	(cs_run_command_script e23_mars_scorpions0/scorpion1 scorpions0_shoot)
	(scarab_walk_low_var0)
	(scarab_walk_low_to_walk_front)
	...
	(if	
		(or
			(object_model_target_destroyed (object_at_marker scarab "side_gun_fl") "target_front")
			g_e23_scarab_arrived_at_end
		)
		(ai_erase scarab_gunners/left_gunner0)
	)
	...
	; End walk
	(cs_run_command_script scarab_gunners/main_gunner blow_them_tf_up)
...
(script command_script e21_cov_wraith0_1_dropoff
	(cs_enable_pathfinding_failsafe true)
	(cs_fly_to e21_cov_phantom_exit/p3)
	(sleep 45)
	(vehicle_unload (ai_vehicle_get ai_current_actor) "phantom_lc")
	(ai_braindead e21_cov_wraiths0_1/wraith0 false)
)
...
(script dormant e21_cov_phantom0_main
	...
	(vehicle_load_magic (ai_vehicle_get_from_starting_location e21_cov_phantom0/phantom0) "phantom_lc" (ai_vehicle_get_from_starting_location e21_cov_wraiths0_1/wraith0))
	(ai_braindead e21_cov_wraiths0_1/wraith0 true)
	...
	(cs_run_command_script e21_cov_phantom0 e21_cov_wraith0_1_dropoff)
...
(script command_script cs_e19_cov_ghosts0_1_entry1
	(cs_enable_pathfinding_failsafe true)
	(cs_vehicle_speed 3.0)
	(cs_fly_to e19_cov_ghosts0_1/p10)
	(cs_fly_to e19_cov_ghosts0_1/p11)
	(cs_fly_to e19_cov_ghosts0_1/p4)
	(sleep 45)
	(begin_random
		(begin (vehicle_unload (ai_vehicle_get ai_current_actor) "phantom_sc01") (sleep 15))
		(begin (vehicle_unload (ai_vehicle_get ai_current_actor) "phantom_sc02") (sleep 15))
	...
	(sleep 15)
	(cs_vehicle_speed 3.0)
	(cs_fly_to_and_face e19_cov_ghosts0_1/p5 e19_cov_ghosts0_1/p6)
	(cs_fly_to e19_cov_ghosts0_1/p6)
	(cs_vehicle_speed 7.0)
	(cs_fly_to e19_cov_ghosts0_1/p7)
	(cs_vehicle_speed 3.0)
	(cs_fly_to e19_cov_ghosts0_1/p8)
	(cs_fly_to e19_cov_ghosts0_1/p9)
	(object_destroy (ai_vehicle_get ai_current_actor))
	(ai_erase ai_current_actor)
)
		...
		(begin
			(if (<= (ai_living_count e19_cov_ghosts0) 0)
				...
				(begin
					...
					(vehicle_load_magic (ai_vehicle_get_from_starting_location e19_cov_ghosts0_1/phantom0) "phantom_sc01" (ai_vehicle_get_from_starting_location e19_cov_ghosts0_1/ghost0))
					(vehicle_load_magic (ai_vehicle_get_from_starting_location e19_cov_ghosts0_1/phantom0) "phantom_sc02" (ai_vehicle_get_from_starting_location e19_cov_ghosts0_1/ghost1))
				)
			)
...
(script command_script bugger_wait
	(cs_abort_on_alert true)
	(cs_abort_on_damage true)
	(sleep_until (volume_test_objects tv_e17_cov_inf2_1_begin (players)))
)
...
(script static void water_not_blind0_0pt1
	...
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_0pt2
	(sleep_until (= (ai_living_count e17_cov_inf0_0) 1))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_0pt3
	(sleep_until (= (ai_living_count e17_cov_inf0_0) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_1pt1
	(sleep_until (= (ai_living_count e17_cov_inf0_1) 1))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_1pt2
	(sleep_until (= (ai_living_count e17_cov_inf0_1) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_2pt1
	(sleep_until (= (ai_living_count e17_cov_inf0_2) 1))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_2pt2
	(sleep_until (= (ai_living_count e17_cov_inf0_2) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind0_3
	(sleep_until (= (ai_living_count e17_cov_inf0_3) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind2_0pt1
	(sleep_until (= (ai_living_count e17_cov_inf2_0) 2))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind2_0pt2
	(sleep_until (= (ai_living_count e17_cov_inf2_0) 1))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind2_0pt3
	(sleep_until (= (ai_living_count e17_cov_inf2_0) 1))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
...
(script static void water_not_blind2_1
	(sleep_until (= (ai_living_count e17_cov_inf2_1) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind2_2pt1
	(sleep_until (= (ai_living_count e17_cov_inf2_2) 1))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind2_2pt2
	(sleep_until (= (ai_living_count e17_cov_inf2_2) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)

(script static void water_not_blind2_3
	(sleep_until (= (ai_living_count e17_cov_inf2_3) 0))
	(ai_disregard (player0) false)
	(ai_disregard (player1) false)
	(sleep 210 water_blind)
)
...
(script dormant e17_cov_inf2_main
	...
	(water_not_blind2_2pt1)
	(water_not_blind2_2pt2)
...
(script dormant e17_cov_inf0_aux
	...
	(water_not_blind0_2pt1)
	(water_not_blind0_2pt2)
...
(script dormant e17_cov_inf0_main
	...
	(if (<= (ai_living_count e17_cov_inf0) 4)
		(begin
			...
			(water_not_blind0_1pt1)
			(water_not_blind0_1pt2)
		)
	)
...
(script dormant water_start
	(sleep_until (volume_test_objects tv_e17_on_first_wall (players)))
	(set water_started true)
	(water_not_blind0_0pt1)
	(water_not_blind0_0pt2)
	(water_not_blind0_0pt3)
	(water_not_blind2_0pt1)
	(water_not_blind2_0pt2)
	(water_not_blind2_0pt3)
	(water_not_blind2_1)
)
...
(script command_script e16_turret_deployment
	(begin_random
		(begin 
			(cs_go_to e16_turrets/p0)
			(cs_deploy_turret e16_turrets/p0)
		)
		(begin 
			(cs_go_to e16_turrets/p1)
			(cs_deploy_turret e16_turrets/p1)
		)
	)
)
...
(script dormant e16_cov_wraiths1_main
	(sleep_until 
		(or
			...
			(<= (+ (ai_living_count e16_cov_ubers) (ai_living_count e16_cov_banshees0)) 1)
		)
	)
...
(script dormant e16_cov_ubers_main
	(sleep_until 
		(or
			(volume_test_objects tv_e16_toll_plaza (players))
...
(script dormant e16_cov_banshees0_main
	...
	; Wake Wave 1 (ghosts)
	(game_save)
	(wake e16_cov_ubers_main)
	
	; Wait until the Ghosts have spawned, then died
	(sleep_until 
		(and
			(> (ai_spawn_count e16_cov_ubers) 0)
			(<= (+ (ai_living_count e16_cov_ubers) (ai_living_count e16_cov_banshees0)) 1)
		)
	)
...
;	(wake e16_cov_ghosts1_main)
	...
	(sleep_forever e16_cov_ubers_main)
...
(script command_script cs_e15_cov_phantom0_1_entry
	...
	(cs_fly_by e15_cov_phantom0_1_entry/p3)
	(cs_fly_to e15_cov_phantom0_1_entry/p1)
	(cs_fly_to e15_cov_phantom0_1_entry/p0)
	(cs_fly_to e15_cov_phantom0_1_entry/p10)
	(cs_fly_to e15_cov_phantom0_1_entry/p11)
	(sleep 60)
...
(script command_script cs_e15_cov_phantom0_0_entry
	(cs_fly_to e15_cov_phantom0_0_entry/p1)
	(cs_fly_to e15_cov_phantom0_0_entry/p2)
	(cs_fly_to e15_cov_phantom0_0_entry/p10 1.0)
	(cs_face true e15_cov_phantom0_0_entry/p2)
	(sleep 30)
	(vehicle_unload (ai_vehicle_get ai_current_actor) "phantom_p")
	(sleep 90)
	(cs_fly_to e15_cov_phantom0_0_entry/p2)
...
(script command_script cs_e15_mars_inf0_unload
	...
	(if 
		(and
			...
			(not (unit_has_weapon (ai_get_unit ai_current_actor) "dw3\objects\weapons\support_high\rocket_launcher_beta\rocket_launcher_beta.weapon"))
		)
		(begin
			(sleep 30)
			(ai_vehicle_exit ai_current_actor)
...
(script dormant e15_cov_phantom0_main
	...
	(ai_place_in_vehicle e15_cov_inf0_1 e15_cov_phantom0_0)
	...
	(ai_place_in_vehicle e15_cov_inf0_2 e15_cov_phantom0_1)
...
(script dormant e15_mars_inf0_main
	...
	(sleep_until (volume_test_objects tv_e15_cov_inf2_1_spring (players)) 15)
	(ai_place e15_mars_inf0 (pin (- 3 (ai_living_count e15_mars_inf0)) 1 2))
)

(script command_script e15_turret_deployment
	(cs_deploy_turret e15_turrets/p0)
	(sleep_forever)
)
...
(script command_script sniper2
	(sleep_until (volume_test_objects tv_e14_blockade3 (players)) 15)
	(sleep 45)
	(cs_force_combat_status 4)
	(cs_go_to e14_cov_snipers0_positions/p0)
	(cs_go_to e14_cov_snipers0_positions/p1)
	(ai_set_orders e14_cov_snipers0/sniper2 e14_cov_sniper0_2)
)

(script command_script sniper1
	(sleep_until (volume_test_objects tv_e14_blockade3 (players)) 15)
	(cs_force_combat_status 4)
	(cs_go_to e14_cov_snipers0_positions/p2)
	(cs_go_to e14_cov_snipers0_positions/p3)
	(ai_set_orders e14_cov_snipers0/sniper1 e14_cov_sniper0_1)
)
...
(script dormant e14_cov_wraiths0_main
	...
	(sleep_until (= (ai_living_count e14_cov_wraiths0) 1))
	(ai_set_orders e14_cov_wraiths0 e14_cov_wraiths0_retreat)
)
