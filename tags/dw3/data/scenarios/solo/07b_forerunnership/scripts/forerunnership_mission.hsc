...
;;	H2 Trench Run, based around the track 'Keyship', queued in multiple stages
;;	as the player progresses further towards the end goal. - Neo
;;	KEYSHIP TEMPO IS 62.5BPM

(script dormant m_voxx
	(sound_looping_start "dw3\sound\music\07b_voxx" none 0.4)
	(sleep 300)
	(sound_looping_stop "dw3\sound\music\07b_voxx")
)

(script dormant m_s1_perc
	(sleep 24)
	(sound_impulse_start "dw3\sound\music\ks_stingers\ks_s_toms" none 1)
	(sleep_until (< (sound_impulse_time "dw3\sound\music\ks_stingers\ks_s_toms" 520) 210))
	(sound_looping_start "dw3\sound\music\07b_s1_perc" none 1)
	(sleep_forever)
	(sound_looping_stop "dw3\sound\music\07b_s1_perc")
)

(script dormant m_s2
	(sound_looping_start "dw3\sound\music\07b_s2" none 1)
	(sleep_forever)
	(sound_looping_stop "dw3\sound\music\07b_s2")
)

(script dormant m_prime
	(print "m Primed!")
	(wake m_voxx)
	(sleep_until (< (objects_distance_to_flag (players) m_01) 10))
	(print "m_01")
	(wake m_voxx)
	(sound_impulse_start "dw3\sound\music\ks_stingers\ks_s_lift" none 1)
	(sleep_until (< (objects_distance_to_flag (players) m_02) 11))
	(print "m_02")
	(wake m_s1_perc)
	(sleep_until (< (objects_distance_to_flag (players) m_03) 11))
	(print "m_03")
	(sleep_until (< (objects_distance_to_flag (players) m_04) 11))
	(print "m_04")
	(sleep_until (< (objects_distance_to_flag (players) m_05) 21))
	(wake m_s1_perc)
	(print "m_05")
	(sleep_until (< (objects_distance_to_flag (players) m_06) 27))
	(sound_impulse_start "dw3\sound\music\voxx\notaloop" none 1)
	(print "m_06")
	(sound_impulse_start "dw3\sound\music\ks_stingers\ks_s_winds" none 1)
	(sleep_until (< (objects_distance_to_flag (players) m_07) 95))
	(wake m_s2)
	(print "m_07")
	(sleep_until (< (objects_distance_to_flag (players) m_08) 10))
	(print "m_08")
	(sleep_until (< (objects_distance_to_flag (players) m_09) 10))
	(print "m_09")
	(sleep_until (< (objects_distance_to_flag (players) m_10) 11))
	(wake m_s2)
	(sound_looping_stop "dw3\sound\music\07b_s2")
	(print "m_10")
	(sleep_until (< (objects_distance_to_flag (players) m_11) 10))
	(sound_looping_stop "dw3\sound\music\07b_s2")
	(print "m_11");	
)
...
(script dormant breadcrumbs_nav_points_07b
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			...
			(sleep_until
				(or
					(volume_test_objects tv_e10_hall_check (players))
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_flag default player anchor_flag_outro1 0)
		)
	)
)
...
(script command_script jugg_intimidate
	(sleep 60)
	(cs_custom_animation objects\characters\flood_juggernaut\flood_juggernaut "combat:unarmed:taunt" 0 1)
	(cs_go_to e14_taunt/p0)
)

(script command_script jump1
	(cs_jump 25 12.5)
)

(script command_script brute_boost
	(cs_ignore_obstacles true)
	(cs_vehicle_boost true)
	(cs_go_to e14_boost/p0)
	(cs_vehicle_boost false)
)

(script command_script jump0b
	(cs_go_to e14_jump0/p1)
	(cs_jump 25 8.5)
)

(script command_script jump0a
	(cs_go_to e14_jump0/p0)
	(cs_jump 25 8.5)
)

(script dormant e14_player_teleport
	(sleep_until (volume_test_objects tv_e14_player_teleport (players)) 5)
	(volume_teleport_players_not_inside tv_e14_player_teleport_check e14_player_teleport)
)

(script dormant e14_start
	(sleep_until (volume_test_objects tv_e14_trigger1 (players)) 5)
	(ai_place e14_pro_tun2_inf0)
	(sleep_until (volume_test_objects tv_e14_trigger2 (players)) 5)
	(game_save)
	(ai_place e14_fld_tun2_inf0)
	(sleep_until (volume_test_objects tv_e14_trigger3 (players)) 5)
	(game_save_immediate)
	(ai_place e14_fld_tun2_inf1a)
	(ai_place e14_fld_tun2_inf1b)
	(ai_place e14_fld_tun2_inf2a)
	(ai_place e14_fld_tun2_inf2b)
	(sleep_until (volume_test_objects tv_e14_trigger4 (players)) 5)
	(ai_disposable e14_pro_tun2_inf0 true)
	(ai_disposable e14_fld_tun2_inf0 true)
	(ai_place e14_fld_tun2_inf3)
	(ai_place e14_fld_tun2_inf4a)
	(ai_place e14_fld_tun2_inf4b)
	(ai_place e14_pro_tun2_inf1a)
	(ai_place e14_pro_tun2_inf1c)
	(sleep_until (volume_test_objects tv_e14_trigger5 (players)) 5)
	(game_save_immediate)
;	(ai_place e14_pro_tun2_inf1b)
	(sleep_until (volume_test_objects tv_e14_trigger6 (players)) 5)
	(ai_place e14_fld_tun2_inf5a)
	(ai_place e14_fld_tun2_inf5b)
	(ai_place e14_pro_tun2_inf2)
	(sleep_until (volume_test_objects tv_e14_trigger7 (players)) 5)
	(ai_place e14_fld_tun2_inf5c)
	(sleep_until (volume_test_objects tv_e14_trigger8 (players)) 5)
	(ai_place e14_fld_tun2_inf6)
)
...
(script command_script flood_boosting1
	(cs_vehicle_boost true)
	(cs_go_to e13_ghosts/p1)
)

(script command_script flood_boosting0
	(cs_vehicle_boost true)
	(cs_go_to e13_ghosts/p0)
)

(script command_script e13_grunts_fleeing
	(cs_movement_mode ai_movement_flee)
	(cs_go_to_nearest e13_grunts)
)

(script dormant e13_start			
	(sleep_until (volume_test_objects tv_e13_trigger1 (players)) 5)
	(set g_e13_started true)
	(ai_place e13_tun1_p1)
	(ai_erase e12_flood_rush)
	(game_save_immediate)
	(sleep_until (volume_test_objects tv_e13_trigger2 (players)) 5)
	(ai_place e13_tun1_p2)
	(sleep_until (volume_test_objects tv_e13_trigger3 (players)) 5)
;	(ai_place e13_fld_tun1_inf7)
	(game_save_immediate)
	(wake e14_start)
	(wake e14_player_teleport)
	(sleep_until (volume_test_objects tv_e14_player_teleport_check (players)) 5)
	(ai_disposable e13_tun1 true)
	(ai_erase e13_tun1)
)
...
(script dormant e13_kill_e12
	(if 
		(and
			(volume_test_objects tv_e13_kill_e12 (player0))
			(volume_test_objects tv_e13_kill_e12 (player1))
		)
		(begin
			(ai_disposable e12_prophets_master true)
			(ai_disposable e12_flood_rush true)
			(object_destroy_containing delete_pls)
			(object_destroy_containing e12_left)
			(object_destroy_containing e12_right)
			(object_destroy_containing plasma_door)
			(sleep_forever)
		)
	)
	(sleep_until (volume_test_objects tv_e13_kill_e12 (players)) 15)
	(volume_teleport_players_not_inside tv_e13_kill_e12 e13_player_teleport)
	(ai_disposable e12_prophets_master true)
	(ai_disposable e12_flood_rush true)
	(object_destroy_containing delete_pls)
	(object_destroy_containing e12_left)
...
(script dormant e12_pelican_flyby
	...
	(ai_disposable e12_CS_pelican1/warthog false)
	(vehicle_load_magic (ai_vehicle_get_from_starting_location e12_cs_pelican1/pilot) "pelican_lc" (ai_vehicle_get_from_starting_location e12_CS_pelican1/warthog))
	(ai_vehicle_enter_immediate e12_cs_pelican1/pgunner (ai_vehicle_get e12_cs_pelican1/pilot) "pelican_g_rear")
	(ai_braindead e12_cs_pelican1/pgunner true)
	(ai_place e12_CS_banshee1)
	(object_cannot_take_damage (ai_vehicle_get_from_starting_location e12_cs_pelican1/warthog))
	(sleep_until (players_in_vehicle) 5)
	(object_can_take_damage (ai_vehicle_get_from_starting_location e12_cs_pelican1/warthog))
)

(script command_script e12_banshees
	(ai_prefer_target (ai_get_object e12_cs_pelican1/pilot) true)
	(ai_magically_see ai_current_actor e12_cs_pelican1/pilot)
)	
...
(script command_script e12_cs_pelican1
	...
	(ai_braindead e12_cs_pelican1/pgunner false)
...
(script dormant bridge_activate
	...
	(if (> (objects_distance_to_object (players) (ai_get_object cortana)) 7) ; pbertone 
					...
					(sleep (ai_play_line_at_player cortana 2060))
			)
	(sleep dialogue_pause)
	(sound_impulse_start sound\ambience\device_machines\holo_button_push\holo_button_push none 1)
	(object_create_containing plasma_door)
	(device_group_set plasma_door_1 plasma_bridge 0)
	(object_create tube)
	(if (game_is_cooperative)
		(object_create coop_ghost)
	)
)

(script dormant e12_tickle
	(if (volume_test_objects tv_e13_kill_e12 (players))
		(sleep_forever)
	)
	(sleep_until (volume_test_objects tv_e12_tickle (players)) 15)
	(wake bridge_activate)
...
(script dormant e12_main
	...
	(sleep_until (= g_e13_started true) 5)
	(sleep_forever e12_tickle)
)

(script static void e12_test
	(switch_bsp 4)
	(sleep 2)
	(wake e12_start)
	(game_save_immediate)
...
(script dormant e10_stuck_door
	(device_set_position e10_stuck_door .64)
	(device_operates_automatically_set e10_stuck_door false)
	(object_create e10_dead_brute)
	(scenery_animation_start_at_frame e10_dead_brute dw3\objects\characters\brute_dw3\brute_scenery h_kill:front:gut 59)
)
...
(script command_script cs_e5_cov_inf0_elite
	...
	(cs_crouch true)
	(sleep_until (volume_test_objects tv_e6_elite_ambush (players)))
	(cs_force_combat_status 3)
	(cs_crouch false)
)

(script dormant e5_cov_inf0_elite_main
	(ai_place e5_cov_inf0_elite)
	(unit_set_active_camo (ai_get_unit e5_cov_inf0_elite) true 0)
	(sleep_until 
		(or
			(volume_test_objects tv_e6_elite_ambush (players))
			(>= (ai_combat_status e5_cov_inf0_elite) 3)
		)
	)	
	(unit_set_active_camo (ai_get_unit e5_cov_inf0_elite) false 2)
	(unit_add_equipment (unit (list_get (ai_actors e5_cov_inf0_elite) 0)) sword true true)
)
...
;	(wake e5_platform_c) this is woken at the same time "e5_platform_a2" is woken 
)
...
(script dormant e5_platform_begin
	...
	(object_create lift_effect_c)
	(sleep 1)
	(device_set_position lift_effect_b 1)
	(device_set_position lift_effect_c 1)
	(objects_attach maus_platform_b "lift_effect" lift_effect_b "lift_effect")
	(objects_attach maus_platform_c "lift_effect2" lift_effect_c "lift_effect")
...
(script dormant e5_start
	(sleep_until (volume_test_objects tv_e5_trigger1 (players)) 15)
	(object_create maus_platform_a)
	(object_create maus_platform_b)
	(object_create maus_platform_c)
	(object_create maus_platform_d)
...
;SPAWN REINFORCEMENTS AS REQUIRED AND TELEPORT THEM NEAR THE DROPSHIPS
	...
	;Troop Drop	(vehicle_unload (ai_vehicle_get ai_current_actor) "pelican_p")
...
(script command_script e1_cs_banshee1
	(cs_vehicle_boost true)
	(cs_fly_by pelican1/p0)
	(cs_fly_by pelican1/p6)
	(cs_vehicle_boost false)
	(ai_prefer_target (ai_get_object e1_cs_pelican1/pilot) true)
)

(script command_script e1_cs_banshee2
	(cs_vehicle_boost true)
	(cs_fly_by pelican1/p1)
	(if (<= (ai_living_count e1_flood_group_1) 3)
		(begin
			(cs_fly_by pelican1/p8)
			(cs_vehicle_boost false)
			(cs_fly_by pelican1/p7)
		)
		(begin
			(cs_fly_by pelican1/p7)
			(cs_vehicle_boost false)
	...
	(ai_prefer_target (ai_get_object e1_cs_pelican2/pilot) true)
)

(script dormant e1_banshee_main
	(sleep 380)
	(ai_place e1_cs_banshee1)
	(sleep 600)
	(ai_place e1_cs_banshee2)
)
