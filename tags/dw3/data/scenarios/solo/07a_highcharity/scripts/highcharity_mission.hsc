...
(script dormant sc_council_exit
	...
	(sleep (ai_play_line_at_player cortana_0 0020))
	(sleep (* dialogue_pause 3))
	
	(if dialogue (print "CORTANA: Let me get these doors..."))
	(sleep (ai_play_line_at_player cortana_0 0030))
	(sleep dialogue_pause)
	...
	(sleep (ai_play_line_at_player cortana_0 0040))
	(sleep dialogue_pause)
...
(script dormant sc_in_amber_clad
	...
	(sleep (ai_play_line_at_player cortana_3a 0070))
	(sleep dialogue_pause)
...
;	(sleep (ai_play_line_on_object ioc_sound_c 0320))
	...
	(sleep (ai_play_line_at_player cortana_3a 0080))
	(sleep dialogue_pause)
	(game_save)
	...
	(sleep (ai_play_line_at_player cortana_3a 2160))
	(sleep (* dialogue_pause 10))

	(set g_music_07a_04 0)
	
	(device_set_power garden_tram_a_bk 0)
	(device_set_position tram_a_bk_effect 0)
	(device_set_power garden_tram_a 1)
	(device_set_power tram_a_effect 1)
	(device_set_position tram_a_effect 1)
