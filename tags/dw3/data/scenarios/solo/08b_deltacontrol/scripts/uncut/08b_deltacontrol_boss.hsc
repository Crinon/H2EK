...
(script static void boss_tartarus_taunt
	(cond
		...
		((= counter_boss_tartarus_taunt 3)								(begin
																	(print "This time, Arbiter, I shall kill you properly!")
																	(sound_impulse_start sound\dialog\levels\08_controlroom\mission\l08_1010_tar (ai_get_object boss_tartarus) 1)
																))
