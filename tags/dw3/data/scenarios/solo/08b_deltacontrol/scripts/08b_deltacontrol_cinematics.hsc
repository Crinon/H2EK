...
(script static void scarab1_idle_twist_left_cin
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab1 combat:idle_to_twist_5_left g_scarab_interpolation1)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_twist_right_cin
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab1 combat:idle_to_twist_5_right g_scarab_interpolation1)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)	
(script static void scarab1_twist_5_left_cin
	(print "scarab_twist_5_left")
	(device_set_position_track scarab1 combat:twist_5_left g_scarab_interpolation1)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_right_cin
	(print "scarab_twist_5_right")
	(device_set_position_track scarab1 combat:twist_5_right g_scarab_interpolation1)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_left_idle_cin
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab1 combat:twist_5_left_to_idle g_scarab_interpolation1)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_right_idle_cin
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab1 combat:twist_5_right_to_idle g_scarab_interpolation1)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_gun_open_up_cin
	(device_set_overlay_track scarab1 combat:fire_open_quiet)
	(device_animate_overlay scarab1 1.0 3.5 0 0)
)
(script static void scarab2_idle_twist_left_cin
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab2 combat:idle_to_twist_5_left g_scarab_interpolation1)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_twist_right_cin
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab2 combat:idle_to_twist_5_right g_scarab_interpolation1)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)	
(script static void scarab2_twist_5_left_cin
	(print "scarab_twist_5_left")
	(device_set_position_track scarab2 combat:twist_5_left g_scarab_interpolation1)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_left_idle_cin
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab2 combat:twist_5_left_to_idle g_scarab_interpolation1)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_right_idle_cin
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab2 combat:twist_5_right_to_idle g_scarab_interpolation1)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_gun_open_up_cin
	(device_set_overlay_track scarab2 combat:fire_open_quiet)
	(device_animate_overlay scarab2 1.0 3.5 0 0)
)

(script dormant scarab1_cin_threat
	(scarab1_gun_open_up_cin)
	(sleep_until
		(begin
			(scarab1_idle_twist_left_cin)
			(scarab1_twist_5_left_idle_cin)
			(scarab1_idle_twist_right_cin)
			(scarab1_twist_5_right_idle_cin)
		false)
	)
)

(script dormant scarab2_cin_threat
	(scarab2_gun_open_up_cin)
	(sleep 30)
	(sleep_until
		(begin
			(scarab2_idle_twist_left_cin)
			(scarab2_twist_5_left_idle_cin)
			(scarab2_idle_twist_right_cin)
			(scarab2_twist_5_right_idle_cin)
		false)
	)
)
...
(script static void c08_intra1_04_problem_actors
	...
	(object_cinematic_lod scarab1 true)
	(object_cinematic_lod scarab2 true)
...
(script static void c08_intra1
	...
	(camera_set_field_of_view 60 0)
	(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab none 1)
	(wake scarab1_cin_threat)
	(wake scarab2_cin_threat)
	(sleep 60)
