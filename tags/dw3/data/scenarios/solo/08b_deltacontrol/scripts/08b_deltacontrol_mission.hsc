...
(script dormant music_08b_06_stop
	(print "music 08b_06 stop")
...
(script dormant breadcrumbs_nav_points_08b
	...
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 9.4 -28.0 16.5 "nav_entrance_1" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 9.4 -28.0 16.5) 2)
...
(global boolean scarab1_dead false)
(global boolean scarab2_dead false)
(global boolean bomb1_armed false)
(global boolean bomb2_armed false)
(global boolean scarab1_crew_lower_cleared false)
(global boolean scarab2_crew_lower_cleared false)
(global boolean bomb_pickup false)
(global boolean scarab_boss_started false)
(global boolean banshee_come_in false)
...
(script static void scarab1_idle_var0
	(print "scarab1_idle_var0")
	(device_set_position_track scarab1 combat:idle:var0 g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_firing
	(print "scarab1_idle_var0")
	(device_set_position_track scarab1 combat:idle:var0 g_scarab_interpolation)
	(device_animate_position scarab1 1.0 6.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_var0_no_block
	(print "scarab1_idle_var0")
	(device_set_position_track scarab1 combat:idle:var0 g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
)
(script static void scarab1_idle_to_walk_front
	(print "scarab1_idle_to_walk_front")
	(device_set_position_track scarab1 combat:idle:2:walk_front g_scarab_interpolation)
	(device_animate_position scarab1 1.0 3 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_var0
	(print "scarab1_walk_front_var0")
	(device_set_position_track scarab1 combat:walk_front:var0 g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_to_idle
	(print "scarab1_walk_front_to_idle")
	(device_set_position_track scarab1 combat:walk_front:2:idle g_scarab_interpolation)
	(device_animate_position scarab1 1.0 3 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_15_left
	(print "scarab1_idle_turn_15_left")
	(device_set_position_track scarab1 combat:turn_15_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_15_right
	(print "scarab1_idle_turn_15_right")
	(device_set_position_track scarab1 combat:turn_15_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_15_right_slow
	(print "scarab1_idle_turn_15_right_slow")
	(device_set_position_track scarab1 combat:turn_15_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_22_left
	(print "scarab1_idle_turn_22_left")
	(device_set_position_track scarab1 combat:turn_22_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_22_right
	(print "scarab1_idle_turn_22_right")
	(device_set_position_track scarab1 combat:turn_22_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_22_right_slow
	(print "scarab1_idle_turn_22_right_slow")
	(device_set_position_track scarab1 combat:turn_22_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_45_left
	(print "scarab1_idle_turn_45_left")
	(device_set_position_track scarab1 combat:turn_45_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_45_right
	(print "scarab1_idle_turn_45_right")
	(device_set_position_track scarab1 combat:turn_45_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_turn_45_right_slow
	(print "scarab1_idle_turn_45_right_slow")
	(device_set_position_track scarab1 combat:turn_45_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_turn15_left
	(print "scarab1_walk_front_turn_15_left")
	(device_set_position_track scarab1 combat:walk_front_turn_15_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_turn15_right
	(print "scarab1_walk_front_turn_15_right")
	(device_set_position_track scarab1 combat:walk_front_turn_15_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_turn22_left
	(print "scarab1_walk_front_turn_22_left")
	(device_set_position_track scarab1 combat:walk_front_turn_22_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_turn22_right
	(print "scarab1_walk_front_turn_22_right")
	(device_set_position_track scarab1 combat:walk_front_turn_22_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_turn45_left
	(print "scarab1_walk_front_turn_45_left")
	(device_set_position_track scarab1 combat:walk_front_turn_45_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_walk_front_turn45_right
	(print "scarab1_walk_front_turn_45_right")
	(device_set_position_track scarab1 combat:walk_front_turn_45_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_to_twist_5_left
	(print "scarab1_idle_to_twist_5_right")
	(device_set_position_track scarab1 combat:idle_to_twist_5_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_to_twist_5_right
	(print "scarab1_idle_to_twist_5_right")
	(device_set_position_track scarab1 combat:idle_to_twist_5_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_left
	(print "scarab1_twist_5_left")
	(device_set_position_track scarab1 combat:twist_5_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_left_firing
	(print "scarab1_twist_5_left")
	(device_set_position_track scarab1 combat:twist_5_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_right
	(print "scarab1_twist_5_right")
	(device_set_position_track scarab1 combat:twist_5_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_right_firing
	(print "scarab1_twist_5_right")
	(device_set_position_track scarab1 combat:twist_5_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_left_to_idle
	(print "scarab1_twist_5_left_to_idle")
	(device_set_position_track scarab1 combat:twist_5_left_to_idle g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_right_to_idle
	(print "scarab1_twist_5_left_to_idle")
	(device_set_position_track scarab1 combat:twist_5_right_to_idle g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_gun_open_up
	(device_set_overlay_track scarab1 combat:fire_open)
	(device_animate_overlay scarab1 1.0 3.5 0 0)
)
(script static void scarab1_gun_fire_up
	(device_set_overlay_track scarab1 combat:fire)
	(device_animate_overlay scarab1 1.0 6 0 0)
)
(script static void scarab1_gun_close_up
	(device_set_overlay_track scarab1 combat:fire_close)
	(device_animate_overlay scarab1 1.0 3.5 0 0)
)
(script static void scarab1_gun_open_down
	(device_set_overlay_track scarab1 combat:fire_down_open)
	(device_animate_overlay scarab1 1.0 3.5 0 0)
)
(script static void scarab1_gun_fire_down
	(device_set_overlay_track scarab1 combat:fire_down)
	(device_animate_overlay scarab1 1.0 6 0 0)
)
(script static void scarab1_gun_fire_down_abort
	(device_animate_overlay scarab1 0.0 3 0 0)
)
(script static void scarab1_gun_close_down
	(device_set_overlay_track scarab1 combat:fire_down_close)
	(device_animate_overlay scarab1 1.0 3.5 0 0)
)
(script static void scarab2_idle_var0
	(print "scarab2_idle_var0")
	(device_set_position_track scarab2 combat:idle:var0 g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_firing
	(print "scarab2_idle_var0")
	(device_set_position_track scarab2 combat:idle:var0 g_scarab_interpolation)
	(device_animate_position scarab2 1.0 6.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_var0_no_block
	(print "scarab2_idle_var0")
	(device_set_position_track scarab2 combat:idle:var0 g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
)
(script static void scarab2_idle_to_walk_front
	(print "scarab2_idle_to_walk_front")
	(device_set_position_track scarab2 combat:idle:2:walk_front g_scarab_interpolation)
	(device_animate_position scarab2 1.0 3 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_var0
	(print "scarab2_walk_front_var0")
	(device_set_position_track scarab2 combat:walk_front:var0 g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_to_idle
	(print "scarab2_walk_front_to_idle")
	(device_set_position_track scarab2 combat:walk_front:2:idle g_scarab_interpolation)
	(device_animate_position scarab2 1.0 3 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn_15_left
	(print "scarab2_idle_turn_15_left")
	(device_set_position_track scarab2 combat:turn_15_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn_15_right
	(print "scarab2_idle_turn_15_right")
	(device_set_position_track scarab2 combat:turn_15_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn15_right_slow
	(print "scarab2_idle_turn_15_right_slow")
	(device_set_position_track scarab2 combat:turn_15_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn22_left
	(print "scarab2_idle_turn_22_left")
	(device_set_position_track scarab2 combat:turn_22_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn22_right
	(print "scarab2_idle_turn_22_right")
	(device_set_position_track scarab2 combat:turn_22_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn22_right_slow
	(print "scarab2_idle_turn_22_right_slow")
	(device_set_position_track scarab2 combat:turn_22_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn45_left
	(print "scarab2_idle_turn_45_left")
	(device_set_position_track scarab2 combat:turn_45_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn45_right
	(print "scarab2_idle_turn_45_right")
	(device_set_position_track scarab2 combat:turn_45_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_turn45_right_slow
	(print "scarab2_idle_turn_45_right_slow")
	(device_set_position_track scarab2 combat:turn_45_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_turn_15_left
	(print "scarab2_walk_front_turn_15_left")
	(device_set_position_track scarab2 combat:walk_front_turn_15_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_turn15_right
	(print "scarab2_walk_front_turn_15_right")
	(device_set_position_track scarab2 combat:walk_front_turn_15_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_turn_22_left
	(print "scarab2_walk_front_turn_22_left")
	(device_set_position_track scarab2 combat:walk_front_turn_22_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_turn22_right
	(print "scarab2_walk_front_turn_22_right")
	(device_set_position_track scarab2 combat:walk_front_turn_22_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_turn_45_left
	(print "scarab2_walk_front_turn_45_left")
	(device_set_position_track scarab2 combat:walk_front_turn_45_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_walk_front_turn45_right
	(print "scarab2_walk_front_turn_45_right")
	(device_set_position_track scarab2 combat:walk_front_turn_45_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_to_twist_5_left
	(print "scarab2_idle_to_twist_5_right")
	(device_set_position_track scarab2 combat:idle_to_twist_5_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_to_twist_5_right
	(print "scarab2_idle_to_twist_5_right")
	(device_set_position_track scarab2 combat:idle_to_twist_5_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_left
	(print "scarab2_twist_5_left")
	(device_set_position_track scarab2 combat:twist_5_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_left_firing
	(print "scarab2_twist_5_left")
	(device_set_position_track scarab2 combat:twist_5_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_right
	(print "scarab2_twist_5_right")
	(device_set_position_track scarab2 combat:twist_5_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 4 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_right_firing
	(print "scarab2_twist_5_right")
	(device_set_position_track scarab2 combat:twist_5_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 6 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_left_to_idle
	(print "scarab2_twist_5_left_to_idle")
	(device_set_position_track scarab2 combat:twist_5_left_to_idle g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_right_to_idle
	(print "scarab2_twist_5_left_to_idle")
	(device_set_position_track scarab2 combat:twist_5_right_to_idle g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_gun_open_up
	(device_set_overlay_track scarab2 combat:fire_open)
	(device_animate_overlay scarab2 1.0 3.5 0 0)
)
(script static void scarab2_gun_fire_up
	(device_set_overlay_track scarab2 combat:fire)
	(device_animate_overlay scarab2 1.0 6 0 0)
)
(script static void scarab2_gun_close_up
	(device_set_overlay_track scarab2 combat:fire_close)
	(device_animate_overlay scarab2 1.0 3.5 0 0)
)
(script static void scarab2_gun_open_down
	(device_set_overlay_track scarab2 combat:fire_down_open)
	(device_animate_overlay scarab2 1.0 3.5 0 0)
)
(script static void scarab2_gun_fire_down
	(device_set_overlay_track scarab2 combat:fire_down)
	(device_animate_overlay scarab2 1.0 6 0 0)
)
(script static void scarab2_gun_fire_down_abort
	(device_animate_overlay scarab2 0.0 3 0 0)
)
(script static void scarab2_gun_close_down
	(device_set_overlay_track scarab2 combat:fire_down_close)
	(device_animate_overlay scarab2 1.0 3.5 0 0)
)
(script dormant scarab_death1
	(print "scarab1 is hella dead")
	(set scarab1_dead true)
	(device_set_position_track scarab1 scarab_death_enter g_scarab_interpolation)
	(device_animate_position scarab1 1.0 5.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script dormant scarab_death2
	(print "rip scarab2")
	(set scarab2_dead true)
	(device_set_position_track scarab2 scarab_death_enter g_scarab_interpolation)
	(device_animate_position scarab2 1.0 5.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)

(script dormant effect_scarab_death_01

	(sleep 27)
	(print "blow main-gun")
	
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion_mouth scarab1 "primary_trigger")
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 t_f_turret))
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 t_f_turret))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "head_destroyed_cine")	
	(sleep 2)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 side_gun_fl))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "neck_destroyed_cine")	
	(sleep 3)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 side_gun_bl))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "neck_destroyed2_cine")		
	(sleep 5)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 side_gun_br))
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 side_gun_fr))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "knee_destroyed_cine")		
	(sleep 2)
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "belly_destroyed_cine")		
	(sleep 3)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 t_b_turret))
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab1 t_b_turret))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "calf_destroyed_cine")		
	(sleep 5)
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab1 "knee_destroyed02_cine")
	(sleep 80)
	(object_destroy (object_at_marker scarab1 holo_scarab_full))		
)

(script dormant effect_scarab_death_02

	(sleep 27)
	(print "blow main-gun")
	
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion_mouth scarab2 "primary_trigger")
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 side_gun_fl))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "head_destroyed_cine")	
	(sleep 2)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 t_b_turret))
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 t_b_turret))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "neck_destroyed_cine")	
	(sleep 3)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 side_gun_bl))
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 side_gun_fr))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "neck_destroyed2_cine")		
	(sleep 5)
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "knee_destroyed_cine")		
	(sleep 2)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 t_f_turret))
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 t_f_turret))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "belly_destroyed_cine")		
	(sleep 3)
	(damage_object dw3\objects\vehicles\wraith_alpha\damage_effects\wraith_mortar_impact (object_at_marker scarab2 side_gun_br))
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "calf_destroyed_cine")		
	(sleep 5)
	(effect_new_on_object_marker dw3\effects\scenarios\objects\covenant\military\scarab\scarab_death_explosion scarab2 "knee_destroyed02_cine")
	(sleep 80)
	(object_destroy (object_at_marker scarab2 holo_scarab_full))	
)

(script dormant scarab1_die
	(wake effect_scarab_death_01)
	(wake scarab_death1)
	(sound_impulse_start dw3\sounds\ambience\device_machines\scarab\scarab_death scarab1 1)
)

(script dormant scarab2_die
	(wake effect_scarab_death_02)
	(wake scarab_death2)
	(sound_impulse_start dw3\sounds\ambience\device_machines\scarab\scarab_death scarab2 1)
)

(script static void scarab_gun_openup_quiet
	(device_set_overlay_track scarab combat:fire_open_quiet)
	(device_animate_overlay scarab 1.0 1 0 0)
)

(script static void scarab1_gun_openup_quiet
	(device_set_overlay_track scarab1 combat:fire_open_quiet)
	(device_animate_overlay scarab1 1.0 1 0 0)
)

(script static void scarab2_gun_openup_quiet
	(device_set_overlay_track scarab2 combat:fire_open_quiet)
	(device_animate_overlay scarab2 1.0 1 0 0)
)

(script static void scarab1_idle_twist_left
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab1 combat:idle_to_twist_5_left g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_idle_twist_right
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab1 combat:idle_to_twist_5_right g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
...
(script static void scarab1_twist_5_left_idle
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab1 combat:twist_5_left_to_idle g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab1_twist_5_right_idle
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab1 combat:twist_5_right_to_idle g_scarab_interpolation)
	(device_animate_position scarab1 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab1) 1.0) 1)
)
(script static void scarab2_idle_twist_left
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab2 combat:idle_to_twist_5_left g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_idle_twist_right
	(print "scarab_idle_to_twist_5_right")
	(device_set_position_track scarab2 combat:idle_to_twist_5_right g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)	
(script static void scarab2_twist_5_left_idle
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab2 combat:twist_5_left_to_idle g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
)
(script static void scarab2_twist_5_right_idle
	(print "scarab_twist_5_left_to_idle")
	(device_set_position_track scarab2 combat:twist_5_right_to_idle g_scarab_interpolation)
	(device_animate_position scarab2 1.0 1.5 0 0 true)
	(sleep_until (>= (device_get_position scarab2) 1.0) 1)
...
(script command_script cs_scarab1_load_right_gun0
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab1 "side_gun_fr")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab1_load_right_gun1
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab1 "side_gun_br")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab1_load_left_gun0
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab1 "side_gun_fl")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab1_load_left_gun1
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab1 "side_gun_bl")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab2_load_right_gun0
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab2 "side_gun_fr")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab2_load_right_gun1
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab2 "side_gun_br")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab2_load_left_gun0
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab2 "side_gun_fl")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)

(script command_script cs_scarab2_load_left_gun1
	(object_hide (ai_get_object ai_current_actor) true)
	(vehicle_load_magic (unit (object_at_marker scarab2 "side_gun_bl")) "scarab_turret_d" (ai_get_object ai_current_actor))
	(cs_enable_targeting true)
	(sleep_forever)
)
...
(script command_script cs_e11_scarab_main_gun_shoot
	...
	(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab 1)
	(sleep 165)
)
...
(script dormant e11_pro_spectres0_main
	...
	(sleep_until 
		(and
			(<= (ai_living_count e11_pro_wraith1) 1)
...
(global boolean guntower_destroyed false)
...
(script command_script cs_e9_pro_phantom0_exit
	...
	(object_can_take_damage (ai_vehicle_get_from_starting_location ai_current_actor))
	(cs_vehicle_boost true)
...
(global boolean scarab1_shoot_now false)
(global boolean scarab2_shoot_now false)

(script command_script cs_e9_shoot_scarab1
	(cs_shoot_point true e11_scarab_gunners/p1)
	(set scarab1_crew_lower_cleared true)
	(sleep 130)
	(wake scarab1_die)
)

(script command_script cs_e9_shoot_scarab2
	(cs_shoot_point true e11_scarab_gunners/p2)
	(set scarab2_crew_lower_cleared true)
	(sleep 130)
	(wake scarab2_die)
)

(script command_script cs_e9_enemy_scarab1_shoot
	(sleep_until
		(begin
			(sleep_until (volume_test_objects tv_scarab_targeting (players)) 5)
			(set scarab1_shoot_now true)
...
(script command_script cs_e9_enemy_scarab2_shoot
	(sleep_until
		(begin
			(sleep_until (volume_test_objects tv_scarab_targeting (players)) 5)
			(set scarab2_shoot_now true)
			(if (game_is_cooperative)
				(begin
					(begin_random
						(cs_shoot true (player0))
...
(script command_script cs_e9_cov_banshee0_1
	(cs_ignore_obstacles true)
	(cs_vehicle_boost true)
	(object_cannot_take_damage (ai_vehicle_get_from_starting_location ai_current_actor))
	(activate_team_nav_point_object default player (ai_vehicle_get_from_starting_location e9_cov_banshees0/1) 0)
	(cs_fly_to e9_cov_banshees0/p0)
	(cs_fly_to e9_cov_banshees0/p2)
	(cs_fly_to e9_cov_banshees0/p3)
	(cs_vehicle_boost false)
	(cs_vehicle_speed 0.5)
	(cs_fly_to e9_cov_banshees0/p1)
	(sleep 75)
	(ai_vehicle_exit ai_current_actor)
	(sleep 30)
	(sleep (ai_play_line_at_player ai_current_actor 0800))
	(sleep 60)
	(deactivate_team_nav_point_object player (ai_vehicle_get_from_starting_location e9_cov_banshees0/1))
	(sleep 30)
)

(script command_script cs_e9_cov_banshee0_2
	(cs_ignore_obstacles true)
	(cs_vehicle_boost true)
	(object_cannot_take_damage (ai_vehicle_get_from_starting_location ai_current_actor))
	(cs_fly_to e9_cov_banshees0/p0)
...
(script command_script guntower_shoot_players
	(cs_shoot true)
	(cs_enable_targeting true)
	(cs_enable_moving true)
	(cs_enable_looking true)
...
(script dormant e9_pro_phantom0_main
	...
	(sleep_until 
		(or
			(<= (ai_living_count e9_pro_inf3_0) 0)
			(<= (ai_living_count e9_pro_phantom0) 0)
		)
	)
	; Signal the retreat
	(set g_e9_pro_phantom0_retreating true)
	(if (> (ai_living_count e9_pro_phantom0) 0)
...
*;
	(sleep_until g_e9_scarab_stepping_down)
	; Move on
	(ai_migrate e9_pro_banshees0 e11_pro_banshees0_1)
)

(script dormant e9_cov_banshee0_main
	(sleep_until (> (ai_living_count e9_pro_phantom0) 0) 5)
	(sleep_until
		(and 
			(= banshee_come_in true)
			(or
				(= g_e9_pro_phantom0_retreating true)
				(<= (ai_living_count e9_pro_phantom0) 0)
			)
		)
	)
	(if (= scarab_boss_started false)
		(ai_place e9_cov_banshees0/1)
	)
	(sleep 150)
	...
	(if 
		(and
			(game_is_cooperative)
			(= scarab_boss_started false)
		)
		(begin
			(sleep 120)
			(ai_place e9_cov_banshees0/2)
		)
	)
)
...
(script dormant guntower_destruction22
	(sleep_until 
		(or
			(<= (object_get_health guntower_turret2) 0)
			(<= (object_get_health guntower_base2) 0)
		)
		5
	)
	(object_set_region_state guntower_turret2 "guntower" destroyed)
	(object_set_region_state guntower_base2 "guntower" destroyed)
	(effect_new dw3\effects\scenarios\objects\covenant\military\cov_guntower\trans_hull_destroyed guntower_destroyed2)
	(ai_kill e9_pro_inf0/5)
)

(script dormant e9_pro_inf0_main
	(ai_place e9_pro_inf0)
	(unit_set_maximum_vitality (unit (ai_get_unit e9_pro_inf0/0)) 0.2 0)
	(unit_set_maximum_vitality (unit (ai_get_unit e9_pro_inf0/1)) 0.2 0)
	(unit_set_maximum_vitality (unit (ai_get_unit e9_pro_inf0/2)) 0.2 0)
	(unit_set_maximum_vitality (unit (ai_get_unit e9_pro_inf0/3)) 0.2 0)
	(unit_set_maximum_vitality (unit (ai_get_unit e9_pro_inf0/4)) 0.2 0)
	(object_create_anew guntower_turret2)
	(object_create_anew guntower_base2)
	(if (= guntower_destroyed false)
		(begin
			(ai_place e9_pro_inf0/5)
			(ai_vehicle_reserve guntower_turret2 true)
			(ai_vehicle_enter_immediate e9_pro_inf0/5 guntower_turret2 "guntower_d")
			(wake guntower_destruction22)
		)
		(begin
			(object_set_region_state guntower_turret2 "guntower" destroyed)
			(object_set_region_state guntower_base2 "guntower" destroyed)
...
(script dormant scarab1_shoot_anims
	(sleep_until
		(begin
			(if (= scarab1_shoot_now true)
				(begin
					(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab1 1.0)
					(scarab1_gun_fire_up)
					(scarab1_idle_firing)
				)
			)
		scarab1_crew_lower_cleared)
	)
)

(script dormant scarab2_shoot_anims
	(sleep_until
		(begin
			(if (= scarab2_shoot_now true)
				(begin
					(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab2 1.0)
					(scarab2_gun_fire_up)
					(scarab2_idle_firing)
				)
			)
		scarab2_crew_lower_cleared)
	)
)

(script dormant scarab1_sideguns
	(ai_place scarab_gunners2/upper_gunner)
	(object_hide (ai_get_object scarab_gunners2/upper_gunner) true)	
	(vehicle_load_magic (unit (object_at_marker scarab1 "t_f_turret")) "scarab_turret_d" (ai_get_object scarab_gunners2/upper_gunner))
	(cs_run_command_script scarab_gunners2/upper_gunner cs_stay_in_turret)
	(ai_place scarab_gunners2/rear_gunner)
	(object_hide (ai_get_object scarab_gunners2/rear_gunner) true)	
	(vehicle_load_magic (unit (object_at_marker scarab1 "t_b_turret")) "scarab_turret_d" (ai_get_object scarab_gunners2/rear_gunner))
	(cs_run_command_script scarab_gunners2/rear_gunner cs_stay_in_turret)
	(sleep_until
		(and
			(<= (object_get_health (object_at_marker scarab1 "t_f_turret")) 0)
			(<= (object_get_health (object_at_marker scarab1 "t_b_turret")) 0)
		)
		5
	)
	(sleep 30)
	(if (> (object_get_health (object_at_marker scarab1 "side_gun_fl")) 0)
		(ai_place scarab_gunners2/left_gun0)
	)
	(if (> (object_get_health (object_at_marker scarab1 "side_gun_br")) 0)
		(ai_place scarab_gunners2/right_gun1)
	)
	(sleep_until
		(and
			(<= (object_get_health (object_at_marker scarab1 "side_gun_fl")) 0)
			(<= (object_get_health (object_at_marker scarab1 "side_gun_br")) 0)
		)
		5
	)
	(ai_erase scarab_gunners2/left_gun0)
	(ai_erase scarab_gunners2/right_gun1)
	(sleep 30)
	(if (> (object_get_health (object_at_marker scarab1 "side_gun_fr")) 0)
		(ai_place scarab_gunners2/right_gun0)
	)
	(if (> (object_get_health (object_at_marker scarab1 "side_gun_bl")) 0)
		(ai_place scarab_gunners2/right_gun1)
	)
	(sleep_until
		(and
			(<= (object_get_health (object_at_marker scarab1 "side_gun_fr")) 0)
			(<= (object_get_health (object_at_marker scarab1 "side_gun_bl")) 0)
		)
		5
	)
	(ai_erase scarab_gunners2/right_gun0)
	(ai_erase scarab_gunners2/left_gun1)
	(sleep 2)
	(sleep_forever)
)

(script dormant scarab2_sideguns
	(ai_place scarab_gunners3/upper_gunner)
	(object_hide (ai_get_object scarab_gunners3/upper_gunner) true)	
	(vehicle_load_magic (unit (object_at_marker scarab2 "t_f_turret")) "scarab_turret_d" (ai_get_object scarab_gunners3/upper_gunner))
	(cs_run_command_script scarab_gunners3/upper_gunner cs_stay_in_turret)
	(ai_place scarab_gunners3/rear_gunner)
	(object_hide (ai_get_object scarab_gunners3/rear_gunner) true)	
	(vehicle_load_magic (unit (object_at_marker scarab2 "t_b_turret")) "scarab_turret_d" (ai_get_object scarab_gunners3/rear_gunner))
	(cs_run_command_script scarab_gunners3/rear_gunner cs_stay_in_turret)
	(sleep_until
		(and
			(<= (object_get_health (object_at_marker scarab2 "t_f_turret")) 0)
			(<= (object_get_health (object_at_marker scarab2 "t_b_turret")) 0)
		)
		5
	)
	(ai_erase scarab_gunners3/upper_gunner)
	(ai_erase scarab_gunners3/rear_gunner)
	(sleep 30)
	(if (> (object_get_health (object_at_marker scarab2 "side_gun_fl")) 0)
		(ai_place scarab_gunners3/left_gun0)
	)
	(if (> (object_get_health (object_at_marker scarab2 "side_gun_br")) 0)
		(ai_place scarab_gunners3/right_gun1)
	)
	(sleep_until
		(and
			(<= (object_get_health (object_at_marker scarab2 "side_gun_fl")) 0)
			(<= (object_get_health (object_at_marker scarab2 "side_gun_br")) 0)
		)
		5
	)
	(ai_erase scarab_gunners3/left_gun0)
	(ai_erase scarab_gunners3/right_gun1)
	(sleep 30)
	(if (> (object_get_health (object_at_marker scarab2 "side_gun_fr")) 0)
		(ai_place scarab_gunners3/right_gun0)
	)
	(if (> (object_get_health (object_at_marker scarab2 "side_gun_bl")) 0)
		(ai_place scarab_gunners3/left_gun1)
	)
	(sleep_until
		(and
			(<= (object_get_health (object_at_marker scarab2 "side_gun_fr")) 0)
			(<= (object_get_health (object_at_marker scarab2 "side_gun_bl")) 0)
		)
		5
	)
	(ai_erase scarab_gunners3/right_gun0)
	(ai_erase scarab_gunners3/left_gun1)
	(sleep 2)
	(sleep_forever)
)

(script dormant crew1_check
	(sleep_until (<= (ai_living_count scarab1_crew_lower) 0) 5)
	(set scarab1_crew_lower_cleared true)
	(ai_erase scarab_gunners2)
	(sleep 5)
	(sleep_forever)
)

(script dormant crew2_check
	(sleep_until (<= (ai_living_count scarab2_crew_lower) 0) 5)
	(set scarab2_crew_lower_cleared true)
	(ai_erase scarab_gunners3)
	(sleep 5)
	(sleep_forever)
)

(script dormant e9_enemy_scarab1_main
	(sleep_until (volume_test_objects tv_e1_canyon_entry (players)) 5)
	(set scarab_boss_started true)
	(game_save_unsafe)
	(ai_place e11_cov_banshees0)
	(ai_erase scarab_gunners/right_gun0)
	(ai_erase scarab_gunners/right_gun1)
	(ai_erase scarab_gunners/left_gun0)
	(ai_erase scarab_gunners/left_gun1)
	(ai_erase scarab_gunners/rear_gunner)
	(ai_erase scarab_gunners/upper_gunner)
	(ai_place scarab_gunners2/main_gunner)
	(ai_place scarab1_crew_upper)
	(object_hide (ai_get_object scarab_gunners2/main_gunner) true)
	(vehicle_load_magic (unit (object_at_marker scarab1 "primary_trigger")) "scarab_turret_d" (ai_get_object scarab_gunners2/main_gunner))
	(cs_run_command_script scarab_gunners2/main_gunner cs_e8_scarab_main_gun_idle)
	(sleep 45)
	(cs_stack_command_script scarab_gunners2/main_gunner cs_e9_enemy_scarab1_shoot)
	(wake scarab1_shoot_anims)
	(sleep 90)
	(activate_team_nav_point_flag default player bomb1 0)
	(activate_team_nav_point_flag default player bomb2 0)
	(sleep_until (volume_test_objects tv_scarab1_interior (players)) 5)
	(ai_place scarab1_crew_lower)
	(wake crew1_check)
	(sleep_until (> (device_get_position plant1) 0) 5)
	(if (= bomb_pickup true)
		(begin
			(object_create bomb)
			(object_teleport bomb bomb1)
		)
	)
	(if (<= (ai_living_count scarab1_crew_lower) 0)
		(begin
			(sleep_forever scarab1_shoot_anims)
		)
	)
	(set bomb1_armed true)
	(object_destroy plant1)
	(object_destroy plant2)
	(deactivate_team_nav_point_flag player bomb1)
	(deactivate_team_nav_point_flag player bomb2)
	(activate_team_nav_point_flag default player safe 0)
	(sleep 10)
	(sleep_until
		(begin	
			(sound_impulse_start sound\game_sfx\multiplayer\countdown_for_respawn bomb 1)
			(sleep 30)
			(sound_impulse_start sound\game_sfx\multiplayer\countdown_for_respawn bomb 1)
			(sleep 30)
		(not (volume_test_objects tv_scarab1 (players))))	
	)
	(wake scarab2_sideguns)
	(sound_impulse_start sound\game_sfx\multiplayer\player_respawn bomb 1) 
	(sleep 15)
	(damage_new objects\weapons\support_high\rocket_launcher\damage_effects\rocket_launcher_explosion bomb1)
	(effect_new effects\impact\explosion_large\satchel_charge\satchel_charge_explosion bomb1)
	(object_destroy bomb)
	(wake scarab1_die)
	(ai_kill scarab1_crew_lower)
	(ai_kill scarab1_crew_upper)
	(ai_erase scarab_gunners2)
	(deactivate_team_nav_point_flag player safe)
)

(script dormant e9_enemy_scarab2_main
	(sleep_until (volume_test_objects tv_e1_canyon_entry (players)) 5)
	(ai_place scarab_gunners3/main_gunner)
	(ai_place scarab2_crew_upper)
	(object_hide (ai_get_object scarab_gunners3/main_gunner) true)
	(vehicle_load_magic (unit (object_at_marker scarab2 "primary_trigger")) "scarab_turret_d" (ai_get_object scarab_gunners3/main_gunner))
	(cs_run_command_script scarab_gunners3/main_gunner cs_e8_scarab_main_gun_idle)
	(sleep 180)
	(cs_stack_command_script scarab_gunners3/main_gunner cs_e9_enemy_scarab2_shoot)
	(wake scarab2_shoot_anims)
	(sleep_until (volume_test_objects tv_scarab2_interior (players)) 5)
	(ai_place scarab2_crew_lower)
	(wake crew2_check)
	(sleep_until (> (device_get_position plant2) 0) 5)
	(if (= bomb_pickup true)
		(begin
			(object_create bomb)
			(object_teleport bomb bomb2)
		)
	)
	(if (<= (ai_living_count scarab2_crew_lower) 0)
		(begin
			(sleep_forever scarab2_shoot_anims)
		)
	)
	(set bomb2_armed true)
	(object_destroy plant1)
	(object_destroy plant2)
	(activate_team_nav_point_flag default player safe 0)
	(deactivate_team_nav_point_flag player bomb1)
	...
	(sleep_until
		(begin	
			...
			(sound_impulse_start sound\game_sfx\multiplayer\countdown_for_respawn bomb 1)
			(sleep 30)
		(not (volume_test_objects tv_scarab2 (players))))	
	)
	(wake scarab1_sideguns)
	(sound_impulse_start sound\game_sfx\multiplayer\player_respawn bomb 1)
	(damage_new objects\weapons\support_high\rocket_launcher\damage_effects\rocket_launcher_explosion bomb2)
	(effect_new effects\impact\explosion_large\satchel_charge\satchel_charge_explosion bomb2)
	(object_destroy bomb)
	(wake scarab2_die)
	(ai_kill scarab2_crew_lower)
	(ai_kill scarab2_crew_upper)
	(ai_erase scarab_gunners3)
	(deactivate_team_nav_point_flag player safe)
)
...
;	(if (difficulty_normal) (wake e9_scarab_navpoint))
	...
	(object_destroy_containing delete_pls)
	(ai_set_orders e8_pro_wraiths0 e9_pro_wraith_fallback)
	(scarab_walk_front_turn_15_left)
	(if (= g_e11_started false)
		(begin
			(ai_place scarab_gunners/right_gun0)
			(ai_place scarab_gunners/right_gun1)
			(ai_place scarab_gunners/upper_gunner)
			(object_hide (ai_get_object scarab_gunners/upper_gunner) true)
			(vehicle_load_magic (unit (object_at_marker scarab "t_f_turret")) "scarab_turret_d" (ai_get_object scarab_gunners/upper_gunner))
			(cs_run_command_script scarab_gunners/upper_gunner cs_stay_in_turret)
		)
	)
	(scarab_walk_front_var0)
	(scarab_walk_front_var0)
	...
	(if (= g_e11_started false)
		(begin
			(ai_place scarab_gunners/left_gun0)
			(ai_place scarab_gunners/left_gun1)
		)
	)
	(game_save_unsafe)
	...
	(if (= scarab1_dead true)
		(begin
			(scarab_gun_openup_quiet)
			(sleep 60)
			(cs_stack_command_script scarab_gunners/main_gunner cs_e9_shoot_scarab2)
			(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab2 1.0)
			(scarab_gun_fire_up)
			(scarab_idle_firing)
			(ai_erase scarab_gunners3)
			(ai_kill scarab2_crew)
			(sleep_forever e9_enemy_scarab2_main)
			(sleep_forever scarab1_sideguns)
			(sleep_forever scarab2_sideguns)
			(scarab_gun_close_up)
		)
		(begin
			(scarab_gun_openup_quiet)
			(sleep 60)
			(cs_stack_command_script scarab_gunners/main_gunner cs_e9_shoot_scarab1)
			(sound_impulse_start sound\ambience\device_machines\scarab\wraith_mortar_charge_scarab scarab2 1.0)
			(scarab_gun_fire_up)
			(scarab_idle_firing)
			(ai_erase scarab_gunners2)
			(ai_kill scarab1_crew)
			(sleep_forever e9_enemy_scarab1_main)
			(sleep_forever scarab1_sideguns)
			(sleep_forever scarab2_sideguns)
			(scarab_gun_close_up)
		)
	...
	(vehicle_load_magic (unit (object_at_marker scarab "t_f_turret")) "scarab_turret_d" (ai_get_object scarab_gunners/upper_gunner))
	(cs_run_command_script scarab_gunners/upper_gunner cs_stay_in_turret)
	(ai_place scarab_gunners/rear_gunner)
	(object_hide (ai_get_object scarab_gunners/rear_gunner) true)
	(vehicle_load_magic (unit (object_at_marker scarab "t_b_turret")) "scarab_turret_d" (ai_get_object scarab_gunners/rear_gunner))
	(cs_run_command_script scarab_gunners/rear_gunner cs_stay_in_turret)
	(scarab_walk_front_turn_22_right)
	(scarab_walk_front_turn_15_left)
	(scarab_walk_front_var0)
...
;	(wake e9_pro_spectres0_main)
	...
	(wake e9_cov_banshee0_main)
;	(wake e9_pro_banshees0_main)
	(wake e9_enemy_scarab1_main)
	(wake e9_enemy_scarab2_main)
...
(script command_script cs_e8_pro_wraith0_0_bombard
	...
	(sleep_until (= bomb_pickup true) 5)
	(if (volume_test_objects tv_e1_advance5 scarab)
		(begin
			(cs_run_command_script ai_current_actor cs_abort)
			(sleep_forever)
		)
	)
...
(script command_script cs_e8_mars_johnson_init
	...
	; Hook him up
	(custom_animation_loop (ai_get_unit ai_current_actor) "objects\characters\marine\marine" "scarab_d_r:any:any:idle:var0" false)
	(object_cinematic_lod (ai_get_object ai_current_actor) true)
...
;	(object_teleport scarab e8_scarab)
	...
	(object_create bomb)
	(activate_team_nav_point_flag default player e8_scarab_waypoint 0)
	(sleep_until (volume_test_objects tv_on_scarab (players)) 5)
	(deactivate_team_nav_point_flag player e8_scarab_waypoint)
	(activate_team_nav_point_object default player bomb 0.5)
	(sleep_until (> (device_get_position pickup) 0) 1)
	(deactivate_team_nav_point_object player bomb)
	(object_destroy pickup)
	(object_destroy bomb)
	(set bomb_pickup true)
	(kill_volume_disable kill_e8_1)
	(sleep 60)
...
;	(objects_attach scarab "plasma_door" scarab_door "")
	...
	(object_hide (ai_get_object scarab_gunners/main_gunner) true)
...
(script dormant e8_pro_wraiths0_main
	...
	(sleep_until (= bomb_pickup true) 120)
	
	; Place the Wraiths, our erstwhile adversaries
	(ai_place e8_pro_wraiths0)
	(unit_set_maximum_vitality (unit (ai_get_unit e8_pro_wraiths0_0)) 0.5 0)
	(unit_set_maximum_vitality (unit (ai_get_unit e8_pro_wraiths0_0)) 0.5 0)
	(unit_set_maximum_vitality (unit (ai_get_unit e8_pro_wraiths0_0)) 0.5 0)
...
(script dormant e8_cov_banshees0_main
	...
	(ai_disregard (ai_get_object e8_cov_banshees0/banshee3) true)
	(sleep_until (= bomb_pickup true))
...
;	(ai_place e8_cov_banshees0/banshee4)
	(ai_disregard (ai_get_object e8_cov_banshees0/banshee2) true)
	(ai_disregard (ai_get_object e8_cov_banshees0/banshee4) true)
...
(script command_script cs_e8_elite_comments
	(cs_switch elite0)
	(cs_play_line 0700)
	(sleep 15)
	(cs_switch elite1)
...
(script dormant e8_elite_comments
	(sleep_until (volume_test_objects tv_scarab (players)))
	(ai_scene e8_humans_and_elites cs_e8_elite_comments e8_cov_inf0)
)
...
(script dormant e8_main
	...
	(object_create e8_banshee2)
	(object_create e8_banshee3)
	...
	(wake e8_scarab_main)
	(object_create_containing flak)
	(object_create_containing gren)
	(wake e8_elite_comments)
	
	; Condemn
	(sleep_until g_e9_started)
	(sleep_forever e8_pro_wraiths0_main)
	(sleep_forever e8_elite_comments)
	(sleep_forever e8_wraith_dialogue)
...
(script dormant e7_main
	...
	(ai_erase e5_pro_phantom0)
	(ai_erase e5_cov_banshees0)
	(ai_erase e5_cov_grunts0)
...
(script dormant guntower_destruction2
	(sleep_until 
		(or
			(<= (object_get_health guntower_turret2) 0)
			(<= (object_get_health guntower_base2) 0)
	...
	(object_set_region_state guntower_base2 "guntower" destroyed)
	(effect_new dw3\effects\scenarios\objects\covenant\military\cov_guntower\trans_hull_destroyed guntower_destroyed2)
	(ai_kill e1_pro_inf0_gunner/1)
	(set guntower_destroyed true)
)
...
(script dormant e5_main
	...
	(wake e5_pro_inf3_main) ; ~vadam
	(wake e5_pro_phantom0_main)
	(if (= guntower_destroyed false)
		(begin
			(ai_vehicle_exit e1_pro_inf0_gunner/1)
			(sleep 60)
			(ai_erase e1_pro_inf0_gunner/1)
			(sleep_forever guntower_destruction2)
		)
	)
	...
	(sleep_forever e5_pro_inf3_main)
	(sleep_forever e5_pro_phantom0_main)
	(ai_erase e4_sen_inf0)
...
(global boolean sen_killed 0)


;- Command Scripts -------------------------------------------------------------

(script command_script cs_e4_sen_inf0_idle
	(cs_abort_on_damage true)
	(sleep_until
		(begin
			(begin_random
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p0)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p1)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p2)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p3)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p4)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p5)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p6)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p7)
					)
				)
				(begin
					(if (= sen_killed 0)
						(cs_fly_to cs_e4_sen_inf0_idle/p8)
					)
				)
			)
		(= sen_killed 1))
	)
	(print "sentinels aggroed")
)

(script command_script cs_e4_sentinel_scene
	(cs_switch elite0)
	(cs_play_line 0590)
	(sleep 15)
	(cs_switch elite1)
...
(script dormant e4_sentinel_spotted
	(sleep_until 
		(ai_scene e4_sentinel_scene cs_e4_sentinel_scene e4_cov)
	)
)
...
(script dormant e4_sen_inf0_main
	(ai_place e4_sen_inf0)
	(ai_disregard (ai_actors e4_sen_inf0) true)
	(sleep_until (<= (ai_living_count e4_sen_inf0) 3))
	(ai_disregard (ai_actors e4_sen_inf0) false)
	(set sen_killed 1)
	(print "sen_killed 1")
)
...
(script dormant e4_main
	...
	(wake e4_sen_inf0_main)
	(wake e4_music)
	(wake e4_sentinel_spotted)
	...
	(sleep_forever e4_sentinel_spotted)
	(sleep_forever e4_sen_inf0_main)
...
(script dormant e3_main
	...
	(game_save)
	(print "e3_main")
	(ai_erase scarab_gunners3/main_gunner)
...
(script dormant e1_pro_inf0_main
	(sleep_until (volume_test_objects tv_e1_advance0 (players)))
	(ai_place e1_pro_inf0_0)
	(ai_place e1_pro_inf0_1)
	(ai_place e1_pro_inf0_gunner/1)
	(ai_vehicle_reserve guntower_turret2 true)
	(ai_vehicle_enter_immediate e1_pro_inf0_gunner/1 guntower_turret2 "guntower_d")
	(wake guntower_destruction2)
)
...
(script dormant e1_cov_wraiths0_main
	...
	(ai_place e1_cov_wraiths0_1) ; Player 1's wraith ~Vadam
	...
	(if (difficulty_legendary)
		(begin
			...
			(unit_set_enterable_by_player (ai_vehicle_get e1_cov_wraiths0_1/wraith1) false)
			(cs_run_command_script e1_cov_wraiths0_0/wraith0 cs_e1_cov_commander0_legendary)
			(cs_run_command_script e1_cov_wraiths0_1/wraith1 cs_e1_cov_commander0_legendary)
		)
...
(script static void test_hunter_room
	(switch_bsp 1)
	(ai_erase scarab_gunners2/main_gunner)
	(ai_erase scarab_gunners3/main_gunner)
	(ai_erase e1_cov)
	(sleep_forever e1_main)
	(sleep_forever e2_main)
	(sleep_forever e3_main)
	(sleep 1)
...
(script dormant mission_start
	...
	; Chapter titles
	(wake chapter_title0)
	(scarab1_gun_openup_quiet)
	(scarab2_gun_openup_quiet)
