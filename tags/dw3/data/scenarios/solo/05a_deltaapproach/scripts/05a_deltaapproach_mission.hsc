...
(script static void lz_phantom_01_	
...
(script command_script bridge_phantom_01a
	...
	(vehicle_unload (ai_vehicle_get_from_starting_location bridge_phantom_01/pilot) "phantom_sc")
;	(sleep 60)
...
;	(cs_fly_by bridge_airspace/pel4 5)
	...
	(vehicle_unload (ai_vehicle_get_from_starting_location bridge_phantom_02/pilot) "phantom_sc")
;	(sleep 60)
...
;	(ai_place bridge_phantom_ghosts_01)
	...
	(sleep 60)
	(vehicle_load_magic (ai_vehicle_get_from_starting_location bridge_phantom_01/pilot) "phantom_sc01" (ai_vehicle_get_from_starting_location bridge_phantom_ghosts_02/1))
	(vehicle_load_magic (ai_vehicle_get_from_starting_location bridge_phantom_01/pilot) "phantom_sc02" (ai_vehicle_get_from_starting_location bridge_phantom_ghosts_02/2))
	(sleep 60)
...
(script static void bridge_phantom_reinforce_02a
	...
	(sleep 60)
	(vehicle_load_magic (ai_vehicle_get_from_starting_location bridge_phantom_02/pilot) "phantom_sc01" (ai_vehicle_get_from_starting_location bridge_phantom_ghosts_02/1))
	(vehicle_load_magic (ai_vehicle_get_from_starting_location bridge_phantom_02/pilot) "phantom_sc02" (ai_vehicle_get_from_starting_location bridge_phantom_ghosts_02/2))
	(sleep 60)
...
;9/12
	...
	(ai_place jets)
	(ai_place temple_ent_bugs_01l)
	(ai_place temple_ent_bugs_01c)
	(ai_place temple_ent_bugs_01r)
	(ai_place temple_ent_bugs_02l)
	(ai_place temple_ent_bugs_02c)
	(ai_place temple_ent_bugs_02r)
...
;	(sleep 450)
	...
	(cs_fly_to_and_face grotto_airspace/ph1 grotto_airspace/p1 3)
	(cs_fly_by grotto_airspace/p1 5)
