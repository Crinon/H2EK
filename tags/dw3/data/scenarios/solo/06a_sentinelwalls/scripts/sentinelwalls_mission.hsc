...
(script dormant jugg_scene
	(ai_place qz_cov_def_flood_j)
	(sleep 180)
	
	(if dialogue (print "SPEC-OPS: Leader! A Juggernaut!"))
	(sleep (ai_play_line qz_cov_def_cov 0560))
	(sleep dialogue_pause)
	
	(if dialogue (print "SPEC-OPS: Foul and unholy beast"))
	(sleep (ai_play_line qz_cov_def_cov 0570))
	(sleep dialogue_pause)
	
	(if dialogue (print "COMMANDER: Close ranks! We'll take it down together!"))
	(sleep (ai_play_line qz_cov_def_soc 0580))
	(sleep dialogue_pause)
	
	(sleep_until (< (ai_strength qz_cov_def_flood_c) .5))
...
(script dormant enc_cov_defense
	...
	(sleep_until (= (ai_living_count qz_cov_def_carrier) 1))
	(wake jugg_scene)
	(sleep 1)
	
	(sleep_until (= (ai_living_count qz_cov_def_flood_j) 0))
