...
(global boolean flood_crust1_spawned false)
(global boolean flood_crust2_spawned false)
(global boolean flood_crust1_destroyed false)
(global boolean flood_crust2_destroyed false)
(global boolean jugg_a_dynamic_spawn false)
(global boolean jugg_b_dynamic_spawn false)
(global boolean sc_factory_exit_done false)
...
(script command_script cs_sc_qz_veh_int
	...
	(sleep (ai_play_line covenant 0630))
	(sleep dialogue_pause)
...
(script dormant sc_ext_b
	(sleep_until (= sc_factory_exit_done true))
...
(script dormant flood_crust_a
	(object_create debris4)
	(object_create debris5)
	(object_create debris6)
	(object_create flood_crust1)
	(set flood_crust1_spawned true)
	(sleep_until (volume_test_objects tv_ext_a_c (players)))
	(sleep_until 
		(or
			(<= (object_get_health (ai_get_object ext_a_flood_ghost_fr)) 0)
			(<= (object_get_health (ai_get_object qz_ext_a_flood_c)) 0)
		)
	)
	(if (= flood_crust1_destroyed false)
		(begin
			(effect_new_on_object_marker "dw3\effects\scenarios\objects\flood\flood_crust\body_destroyed" flood_crust1 target_main)
			(object_destroy flood_crust1)
			(set jugg_a_dynamic_spawn true)
			(ai_place qz_ext_a_jugg/a)
			(ai_place qz_ext_a_flood_c/d)
			(ai_place qz_ext_a_flood_c/e)
			(ai_place qz_ext_a_flood_c/f)
		)
	)
)

(script dormant flood_crust_b
	(object_create debris1)
	(object_create debris2)
	(object_create debris3)
	(object_create flood_crust2)
	(set flood_crust2_spawned true)
	(sleep_until (volume_test_objects tv_ext_a_d (players)))
	(sleep_until 
		(or
			(<= (object_get_health (ai_get_object ext_a_flood_ghost_fr)) 0)
	...
	(if (= flood_crust2_destroyed false)
		(begin
			(effect_new_on_object_marker "dw3\effects\scenarios\objects\flood\flood_crust\body_destroyed" flood_crust2 target_main)
			(object_destroy flood_crust2)
			(set jugg_b_dynamic_spawn true)
			(ai_place qz_ext_a_jugg/b)
			(ai_place qz_ext_a_flood_d)
		)
	)
)

(script dormant flood_crust1_dead
	(sleep_until (= flood_crust1_spawned true))
	(sleep_until (<= (object_get_health flood_crust1) 0) 0)
	(ai_play_line_on_object jugg_a_sound 0180)
	(if (not (= jugg_a_dynamic_spawn true))
		(begin
			(ai_place qz_ext_a_jugg/a)
			(ai_place qz_ext_a_flood_c/d)
			(ai_place qz_ext_a_flood_c/e)
	...
	(set flood_crust1_destroyed true)
)

(script dormant flood_crust2_dead
	(sleep_until (= flood_crust2_spawned true))
	(sleep_until (<= (object_get_health flood_crust2) 0) 0)
	(ai_play_line_on_object jugg_b_sound 0180)
	(if (not (= jugg_b_dynamic_spawn true))
		(begin
			(ai_place qz_ext_a_jugg/b)
			(ai_place qz_ext_a_flood_d)
		)
	)
	(set flood_crust2_destroyed true)
)

(script dormant flood_crusts
	(sleep_until
		(or
...
(global boolean crust3_destroyed false)
(global boolean crust4_destroyed false)
...
(script dormant flood_crust3_main
	(sleep_until (<= (object_get_health flood_crust3) 0) 0)
	(ai_play_line_on_object jugg_a_sound2 0180)
	(ai_place qz_ext_b_ent_jugg/a)
	(set crust3_destroyed true)
	(sleep 150)
	(if (not crust4_destroyed)
		(begin
			(effect_new_on_object_marker "dw3\effects\scenarios\objects\flood\flood_crust\body_destroyed" flood_crust4 target_main)
			(object_destroy flood_crust4)
		)
	)		
)

(script dormant flood_crust4_main
	(sleep_until (<= (object_get_health flood_crust4) 0) 0)
	(ai_play_line_on_object jugg_b_sound2 0180)
	(ai_place qz_ext_b_ent_jugg/b)
	(set crust4_destroyed true)
	(sleep 150)
	(if (not crust3_destroyed)
		(begin
			(effect_new_on_object_marker "dw3\effects\scenarios\objects\flood\flood_crust\body_destroyed" flood_crust3 target_main)
			(object_destroy flood_crust3)
		)
	)
)

(script dormant flood_crusts_2
	(wake flood_crust3_main)
	(wake flood_crust4_main)
)
...
(script command_script cs_e24_fld_inf0_load
	...
	(if (= (random_range 0 2) 0)
		(begin
			(cs_go_to e24_fld_inf1_load/p2_0)
			(cs_go_to e24_fld_inf1_load/p2_1)
		)
		(begin
			(cs_go_to e24_fld_inf1_load/p2_2)
			(cs_go_to e24_fld_inf1_load/p2_3)
		)
	)
...
(script command_script cs_e24_fld_juggernaut_load
	(cs_enable_moving true)
	(cs_enable_targeting true)
	(cs_face_object true key)
	...
	(cs_ignore_obstacles true)
	(cs_enable_pathfinding_failsafe true)
	(cs_go_to jugg_jump/p0)
	(cs_go_to jugg_jump/p1)

	; Jump in
	(cs_jump_to_point 5 2)
...
(script dormant e24_fld_inf2_main
	...
	(sleep 980)
	(ai_place e24_fld_inf2)
)

(script dormant e24_fld_inf1_main
	(sleep_until g_key_shaft_rising 10)
	(ai_place e24_fld_inf1_0)
	(ai_place e24_fld_inf1_1)
	(ai_place e24_fld_juggernaut)
	
	(print "Spec-Ops: The parasite intends to attack from above!")
	(print "Spec-Ops: Prepare yourselves!")
	(sleep (ai_play_line e21_cov_inf0 0870))
	(sleep 330)
	
	(print "Spec-Ops: Blast! A Juggernaut!")
	(sleep (ai_play_line e21_cov_inf0 0840))
	(sleep dialogue_pause)
	
	(print "Spec-Ops: Take cover!")
	(sleep (ai_play_line e21_cov_inf0 0880))
	(sleep dialogue_pause)
)
...
(script dormant e20_cov_inf0_main
	...
	(ai_migrate covenant e20_cov_inf0)
)

(script dormant e20_fld_main
	(ai_place e20_fld_combats0)
)
...
;		(wake dam_door_b)
		(wake flood_crusts)
		(wake flood_crust1_dead)
		(wake flood_crust2_dead)
	...
	(sleep_until (volume_test_objects qz_ext_a_dam_b (players)))
		...
		(ai_place qz_ext_a_dam_flood_juggs)
		(sleep 90)
		(if dialogue (print "SPEC-OPS: Arbiter! Juggernauts!"))
		(sleep (ai_play_line covenant 0670))
		(sleep dialogue_pause)
...
;		(game_save)
	...
	(sleep_until (volume_test_objects tv_ext_a_c (players)))
		...
		(if (= flood_crust1_spawned true)
			(begin
				(ai_place qz_ext_a_flood_c/a)
				(ai_place qz_ext_a_flood_c/b)
				(ai_place qz_ext_a_flood_c/c)
			)
